...
parser.add_argument('--desired_time', type=str, required=True, help='Desired time step (e.g., "latest" or a specific time like "10.0")')
parser.add_argument('--case', type=str, required=True, help='The OpenFOAM case directory')
